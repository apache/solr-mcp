...
## Active Technologies
- Java 25 (GraalVM 25+, enforced via Gradle toolchain) + Spring Boot 4.0.2, Spring AI 2.0.0-M2, SolrJ 10.0.0, `org.graalvm.buildtools.native:0.11.4`, `jib-native-image-extension-gradle:0.1.0`, Jib 3.4.5 (001-graalvm-native-image)

## Recent Changes
- 001-graalvm-native-image: Added Java 25 (GraalVM 25+, enforced via Gradle toolchain) + Spring Boot 4.0.2, Spring AI 2.0.0-M2, SolrJ 10.0.0, `org.graalvm.buildtools.native:0.11.4`, `jib-native-image-extension-gradle:0.1.0`, Jib 3.4.5
