...
/**
 * Utility class for processing CSV documents and converting them to
 * SolrInputDocument objects.
 *
 * <p>
 * This class handles the conversion of CSV documents into Solr-compatible
...
public class CsvDocumentCreator implements SolrDocumentCreator {
	 ...
	 * configuration. It processes CSV data by using the first row as field headers
	 * and converting each subsequent row into a document.
	 *
	 * <p>
	 ...
	 *
	 * <p>
	 * <strong>CSV Processing Rules:</strong>
	 *
	 * <ul>
	 * <li><strong>Header Row</strong>: First row defines field names, automatically
	 * sanitized
	 * <li><strong>Empty Values</strong>: Ignored and not indexed
	 * <li><strong>Type Detection</strong>: Solr handles numeric, boolean, and
	 * string types automatically
	 * <li><strong>Field Sanitization</strong>: Column names cleaned for Solr
	 * compatibility
	 * </ul>
	 *
	 * <p>
	 ...
	 *
	 * @param csv
	 *            CSV string containing document data (first row must be headers)
	 * @return list of SolrInputDocument objects ready for indexing
	 * @throws DocumentProcessingException
	 *             if CSV parsing fails, input validation fails, or the structure is
	 *             invalid
