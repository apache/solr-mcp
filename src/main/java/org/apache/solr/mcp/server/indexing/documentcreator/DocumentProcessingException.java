 ...
 *
 * <p>
 * This exception provides a unified error handling mechanism for all document
 * creator implementations, wrapping various underlying exceptions while
 * preserving the original error context and stack trace information.
 *
 * <p>
...
public class DocumentProcessingException extends RuntimeException {
	...
	/**
	 * Constructs a new DocumentProcessingException with the specified detail
	 * message.
	 *
	 * @param message
	 ...
	 *            the detail message explaining the error
	 * @param cause
	 *            the cause of this exception (which is saved for later retrieval)
	 */
	 ...
	 *
	 * <p>
	 * The detail message is automatically derived from the cause's toString()
	 * method.
	 *
	 * @param cause
	 *            the cause of this exception (which is saved for later retrieval)
