...
| `index-markdown-documents` | Index markdown documents into a collection (one per YAML front matter block), extracting front matter, title, headings, and body text |
